      ...
      <React.Fragment>
        <header className="s-header">
          ...
          <a className="s-header__menu-toggle" href="#0" title="Menu">
              <span class="s-header__menu-icon" />
          </a>
        </header>
        ...
        <section id="hero" class="s-hero target-section">
            ...
            <div className="row s-hero__content">
                ...
                <div className="s-hero__content-about">
                    ...
                    <a className="smoothscroll" href="#about">Scroll Down</a> and learn more <a className="smoothscroll" href="#about">about me</a>.
                    </h3>
                    <div className="s-hero__content-social">
                    <a href="https://github.com/Javierlozo" target="_blank"><i className="fab fa-github" aria-hidden="true" /></a>
                    <a href="https://www.linkedin.com/in/luisjlozoya/" target="_blank"><i className="fab fa-linkedin" aria-hidden="true" /></a>
                    <a href="https://twitter.com/LuisLoz99181092" target="_blank"><i className="fab fa-twitter" aria-hidden="true" /></a>
                    </div>
